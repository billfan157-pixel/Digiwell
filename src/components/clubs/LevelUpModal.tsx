  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" onClick={onClose}>
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm bg-slate-900 border border-amber-500/30 rounded-[2.5rem] p-8 shadow-[0_0_50px_rgba(245,158,11,0.25)] overflow-hidden"
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-amber-300 font-bold text-lg mt-1">Bạn đã đạt cấp độ mới</p>
          ...
          <p className="text-slate-400 text-sm mb-8">Phần thưởng và thử thách mới đã được mở khóa. Hãy tiếp tục cố gắng nhé!</p>

          <button onClick={onClose} className="w-full py-4 rounded-2xl bg-white/10 border border-white/10 text-white font-bold active:scale-95 transition-all hover:bg-white/20">
            Tuyệt vời!
          </button>
        </div>
      </motion.div>
